...
#define CUSTOM_MACHINE_NAME "Anycubic Focus Plus 2"
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 150, 150}

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 200, 200, 200, 200 } // ...or, set your own edit limits
#endif
 ...
 */
#define DEFAULT_ACCELERATION         1000 // 600    // X, Y, Z and E acceleration for printing moves
...
#define DEFAULT_EJERK   15 //  5.0  // May be used by Linear Advance
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -21.0 }
...
#define XY_PROBE_FEEDRATE (70*60)// (16*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST  (70*60) // (50*60)
...
#define HOMING_FEEDRATE_MM_M { (95*60), (95*60), (95*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, 60 }
